...
services = [
    ...
    {"name": "Product Service", "path": "backend/product-service/app.py", "port": 5002},
    {"name": "Booking Service", "path": "backend/booking-service/app.py", "port": 5003},
    {"name": "Portfolio Service", "path": "backend/portfolio-service/app.py", "port": 5004},
    {"name": "Email Service", "path": "backend/email-service/app.py", "port": 5005},
]
